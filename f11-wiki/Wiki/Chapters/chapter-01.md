...
[[ninja]] loses a boss fight, which cracks a gate, which lets [[autofix]]'s restored comms through
to wake a bot that has been asleep for generations.
...
- The awakened shrine bot, which detects [[the-second-signal]] in chapter two.
