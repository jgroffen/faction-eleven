...
loading both into chapter two, the Mystics' gameplay and the arrivals sit here together.
...
3. **[[the-convergence-at-the-monastery]]** — the Ninja, Mifix and the Gargoyle arrive. [[mifix]]
   ...
   `ACCESS DENIED` branch of [[autofix-skill-tree]]. Then the council: the three want to reach the
   [[robots]], nobody present knows where the gate is, and the party settles on finding a Werebeast
   gargoyle — for the gate's location, for the Gargoyle's answer, to seal the gate to the Mystics,
   and to warn them about [[val]].
...
- **A glitch scene** — the first the game shows on purpose, in a companion who is also the
  save/restore mechanic in [[realm-07]].
...
**Depends on:** [[the-trial-of-the-last-gargoyle]], [[the-second-signal]] and
[[the-calling-of-ancient-allies]], all chapter two.
