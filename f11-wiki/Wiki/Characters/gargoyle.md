...
protagonist opposed to his own faction's project — the tension the roster always implied, now with
someone inside it.

**His instructions forbid it.** A gargoyle may not act except in defence of a realm being invaded,
and may not work against its own faction. Stopping his faction's war is, on its face, both. Two
readings, and the game turns on which:

- **He is malfunctioning.** The hammer took the leash along with the power.
...
Player character. Infiltrator archetype. Currency: Gold. His game style is
[[gargoyle-stone-metroidvania]] — the Ninja's platforming engine with a different move set and no
rhythm layer, structured as a Metroid.

**He has no combat verb at all.** He cannot fight, because he is trying to save the people he is
sneaking past. **Stone-drop** knocks opponents out; that is as far as it goes. He starts able to do
exactly one thing — **stealth while standing still** — and ends in sonic flight.

## Quests

<!-- gd:quests:start -->
- [[the-waking-of-the-last-gargoyle|The Waking Of The Last Gargoyle]] · design
<!-- gd:quests:end -->
