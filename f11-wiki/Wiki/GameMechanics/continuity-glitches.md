...
**[[gargoyle]] is the exception and the tutorial for it.** He wakes with an unedited memory of the
world before his torpor and a realm whose history has moved underneath him. He is a continuity
checker by construction, so chapter two is where glitches must start.
