...
# Handover: Glitch causes and manifestation
...
that mapping is an inference and has not been checked.
...
- **Why the argument is unbearable, stated precisely.** [[the-linking-of-the-realms]] has the
  ...
  was supposed to trade one for the other and it bought neither cleanly, which is why neither senior
  can claim their remedy worked.

**Do not re-propose** — settled while building the timeline: strong/subtle is a **loudness tier
independent of kind** (any of the five kinds can be authored at either), not a synonym for
leakage-versus-the-rest.
