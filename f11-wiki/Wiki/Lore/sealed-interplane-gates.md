...
The gates are the concrete, findable form of the multiverse. A faction that knows nothing of the
other realms still knows it has a sealed door — and a locked door is evidence of a locksmith,
which is the thread the whole mystery hangs from.
...
Central and visible. Gates are the goals, the boundaries and the reveals of most faction stories.
