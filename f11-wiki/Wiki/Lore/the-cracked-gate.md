...
The sealed gates do not merely stop travellers; they stop **signals**
([[allied-faction-signals]]). The old devices the factions left for each other never broke — the
...
historically friendly** ([[the-wheel-of-realms]]). The first crack in the silence opens between the
two realms that were closest to begin with, and the machine that comes through belongs to the
...
Yes — this is a chapter-one climax. The player loses a boss fight and is shown the consequence:
