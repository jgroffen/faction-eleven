...
There are **six classes**, and **each faction has a 'faction class' that fulfils the role of that
class for that faction**. A Medic among the [[robots]] is not a Medic among the [[aliens]] — same
role, different people, different idiom.

This is **lore the faction stories can leverage, not rigid mechanics**.

**Canon:** proposed · **Era:** all of it

## The Story

The six roles, and the protagonist who carries each:
...
**Every faction has all six** — sixty faction classes, ten by six, with no gaps. The **protagonist
of each faction is one of its own six**, which is why the asymmetry above exists: it is an artefact
of *which* class each protagonist was drawn from, not of any faction lacking a role.
...
- **The minotaur and the giant are green-skins.** Both are green-skin faction classes — Heavy
  Weapons and Front Liner. So the two who smashed the gargoyles' heads
  ([[the-smashing-of-the-gargoyles]]) were **green-skins destroying green-skin dead, on a damned
  woman's order**.
- **[[val]] is a Vampire, the [[the-damned]]'s Commander class.** Fitting for someone who gives an
  order and leaves.
...
- [[faction-unique-features]] — the mechanical convergence, as opposed to this, the fictional one.
- [[the-wheel-of-realms]] — whether class placement correlates with position on the wheel is
  unexamined.

## Player-Facing

As flavour and story material rather than as a systems layer the player builds against — stories
*leverage* it. Whether the player ever sees the word "class" is undecided.

## Open

That six roles recur across ten severed realms is a **clue with no explanation attached**. It
could be coincidence, convergent evolution, or evidence that [[faction-eleven-antagonist]] shaped
all ten. Nothing establishes which, and the last reading is free plot if it's wanted.

The matrix makes the clue loud. It is not six roles loosely recurring — it is a **complete grid with
no gaps**, in ten realms that have been out of contact long enough to forget each other exists.
Robots and fey folk and undead all field exactly one Commander, one Medic, one Infiltrator.
Convergent evolution does not usually produce a spreadsheet.

The realms were also **numbered** by the Ancients ([[the-wheel-of-realms]]), and catalogued as
opposites and neighbours. A faction that numbers things and arranges them in a ring is a faction
that might also have decided each realm should have six roles.
