...
A siege the player is meant to lose. Waves are held; the last one is not. What breaks the outpost
...
customer at the end of a commercial chapter is a real question ([[chapter-based-release]]).

## Design Note

The tower defence must be tuned so that losing reads as **overwhelming force**, not player
failure. See [[celestials-hero-tower-defence]] — this faction is built around defeat.

## Open

- Whether the player can win it, and what happens if they do.
- Whether the retreat is played or told.
